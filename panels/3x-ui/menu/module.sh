...
panel_menu_impl() {
  ...
  while true; do
    ...
    2)
      ...
      printf 'The panel generates subscriptions from its own settings; staging only\n'
      printf 'places a file in BaToHub state storage.\n'
      case "$(ui_menu_choice)" in
